...
struct AttentionDecayMask
  ...
  function AttentionDecayMask(mask::Matrix{Float32}, decay_function::Function,
    max_distance::Int, decay_rate::Float32)
...
"""
function create_graph_attention_mask(adjacency_matrix::SparseMatrixCSC{Float32}, config::SpatialAttentionConfig)
...
"""
function create_hierarchical_attention_mask(adjacency_matrices::Vector{SparseMatrixCSC{Float32}}, config::SpatialAttentionConfig)
...
"""
function compute_attention_distances(attention_scores::Matrix{Float32}, mask::AttentionDecayMask)
...
"""
function apply_spatial_bias(attention_scores::Matrix{Float32}, positions::Vector{Int}, config::SpatialAttentionConfig)
...
struct MultiHeadAttentionWithDecay
  ...
  function MultiHeadAttentionWithDecay(input_dim::Int, num_heads::Int, head_dim::Int, dropout_rate::Float32)
...
"""
function (attention::MultiHeadAttentionWithDecay)(query::Matrix{Float32}, key::Matrix{Float32}, value::Matrix{Float32},
  decay_mask::AttentionDecayMask)
  ...
  context = reshape(context, batch_size, seq_length, attention.num_heads * attention.head_dim)
