...
export TestingGate,
    CompilationGate, CoverageGate, IntegrationGate, PerformanceGate, DocumentationGate
export run_testing_gate,
    check_compilation,
    check_coverage,
    check_integration,
    check_performance,
...
function check_compilation(gate::CompilationGate)::TestingResult
    ...
    try
        ...
        details = Dict("error_type" => typeof(e).name.name, "error_message" => string(e))
